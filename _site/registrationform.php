...
Thank you for registering for ICMIE 2016. If you have requested any official letters, please allow up to 5 business days to receive your documents.

If you are an author, please make sure to send us your camera ready version and a signed copyright form via email to info@icmie.net. You can find the copyright form here: www.icmie.net/papers. Please note that failing to do so may result in an unsuccessful process of your registration.
...
$your_subject = "Your Registration Details for ICMIE'16";

$your_headers = "From: ICMIE'16 <" . $my_email . ">";
...
<title>ICMIE'16 - Registration Form Filled!</title>
...
<div id="content">
  ...
  <header>
	...
	<div class="cbp-af-inner">
        ...
        <div class="bg">
          <h1>5<sup>th</sup> International Conference on Mechanics<br>and Industrial Engineering (ICMIE'16)</h1>
          <p class="subhead">August 22 - 23, 2016 | Budapest, Hungary</p>
 ...
 <div class="unit unit-s-3-4 unit-m-3-4 unit-l-3-4">
  ...
  <div class="unit unit-s-1 unit-m-1-3-1 unit-l-1-3-1">
    ...
    <div>
      <h2 class="title">1</h2>
      <p class="bold">ICMIE 2016:</p>
      <p class="body">ICMIE 2016 will  be held in Ottawa, Canada on August 22 - 23, 2016.</p>
    </div>          
    <div>
      <h2 class="title">2</h2>
...
<div class="unit unit-s-1 unit-m-1-4-1 unit-l-1-4-1">
  <div class="unit-spacer content">
	...
	<p class="body">We are looking forward to seeing you at ICMIE'16!</p>
  </div>
</div>
...
<footer id="contact">
	...
	<div class="unit-spacer">
	<p class="body">For questions or comments regarding ICMIE'16, please fill out the form below:</p>
