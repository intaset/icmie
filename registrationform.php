<?php
$my_email = "registration@icmie.net";
$errors = array();
...
Thank you for registering for ICMIE 2017. If you have requested any official letters, please allow up to 5 business days to receive your documents.

If you are an author, please make sure to send us your camera ready version and a signed copyright form via email to info@icmie.net. You can find the copyright form here: www.2017.icmie.net/papers. Please note that failing to do so may result in an unsuccessful process of your registration.

You can find your registration details below. If there are any errors in the information you have provided, please write an email to us at registration@icmie.net mentioning the correct information. Please note that you SHOULD NOT refill the form.
...
$your_subject = "Your Registration Details for ICMIE'17";

$your_headers = "From: ICMIE'17 <" . $my_email . ">";
...
<meta name="keywords" content="mechanical engineering conference, robotics conference, energy conference, fluid dynamics conference, cfd conference, industrial engineering conference, mechanics conference, heat transfer, instrumentation, combustion, mechatronics, mems, nanotechnology, renewable energy, solid mechanics, fluid flow, flow, multiphase flow, multiphase heat transfer, turbulent flow, fluid mechanics, mechanical engineering, robotics, energy, fluid dynamics, cfd, industrial engineering, mechanics, heat transfer conference, instrumentation conference, combustion conference, mechatronics conference, mems conference, nanotechnology conference, renewable energy conference, solid mechanics conference, fluid flow conference, flow conference, multiphase flow conference, multiphase heat transfer conference, turbulent flow conference, fluid mechanics conference">
<title>ICMIE'17 - Registration Form Filled!</title>
 ...
 <div class="unit unit-s-3-4 unit-m-3-4 unit-l-3-4">
  ...
  <div class="unit unit-s-1 unit-m-1-3-1 unit-l-1-3-1">
    ...
    <div>
      ...
      <p class="body">ICMIE 2017 will  be held in Rome, Italy on June 9 - 10, 2017.</p>
<!-- 
...
<div class="unit unit-s-1 unit-m-1-4-1 unit-l-1-4-1">
  ...
  <p class="body">We are looking forward to seeing you at ICMIE'17!</p>
  </div>
</div>
